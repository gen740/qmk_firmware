...
const PROGMEM dvorak_keymap dvmap[DVORAK_KEY_NUMBER] = {
    ...
    // Ctrl + Special keys
    {.key = B_LSFT | B_E | B_N, .val = SS_LCTL("^")},
    {.key = B_LSFT | B_J | B_W, .val = SS_LCTL(SS_TAP(X_TAB))},
    ...
    // Symbol keys
    {.key = B_H | B_T | B_QUOT, .val = "`"},
    {.key = B_H | B_T | B_COMM, .val = "%"},
    {.key = B_H | B_T | B_DOT, .val = "{"},
    {.key = B_H | B_T | B_P, .val = "("},
    {.key = B_H | B_T | B_Y, .val = "["},
    ...
    {.key = B_E | B_U | B_D, .val = "_"},
    {.key = B_E | B_U | B_H, .val = "-"},
    {.key = B_E | B_U | B_T, .val = "*" },
    {.key = B_E | B_U | B_N, .val = "^"},
    {.key = B_E | B_U | B_S, .val = "~"},

    {.key = B_H | B_T | B_SCLN, .val = "" },
    {.key = B_H | B_T | B_Q, .val = ""},
    {.key = B_H | B_T | B_J, .val = "&"},
    {.key = B_H | B_T | B_K, .val = "="},
    {.key = B_H | B_T | B_X, .val = ""},
    ...
    {.key = B_T | B_N | B_QUOT, .val = ""},
    {.key = B_T | B_N | B_COMM, .val = "1"},
    {.key = B_T | B_N | B_DOT, .val = "2"},
    {.key = B_T | B_N | B_P, .val = "3"},
    {.key = B_T | B_N | B_Y, .val = ""},

    {.key = B_T | B_N | B_A, .val = ""},
    {.key = B_T | B_N | B_O, .val = "4"},
    {.key = B_T | B_N | B_E, .val = "5"},
    {.key = B_T | B_N | B_U, .val = "6"},
    {.key = B_T | B_N | B_I, .val = "0"},

    {.key = B_T | B_N | B_SCLN, .val = ""},
    {.key = B_T | B_N | B_Q, .val = "7"},
    {.key = B_T | B_N | B_J, .val = "8"},
    {.key = B_T | B_N | B_K, .val = "9"},
    {.key = B_T | B_N | B_X, .val = ""},
